rails_root = "/home/deploy/docyt-preproduction/current"
...
God.watch do |w|
  ...
  w.env = { 'RAILS_ENV' => 'preproduction' }

  w.start = "sudo /etc/init.d/unicorn start"
  w.stop = "sudo /etc/init.d/unicorn stop"
  w.restart = "sudo /etc/init.d/unicorn restart"
